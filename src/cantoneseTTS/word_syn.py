...
# Default paths
parser.add_argument('--canPhones', default="./wordsyn/jyutping-wong-44100-v9/jyutping-wong/", help="Folder containing Cantonese wavs")
parser.add_argument('--mandPhones', default="./wordsyn/pinyin-yali-44100/", help="Folder containing Mandarin wavs")
# User interface
